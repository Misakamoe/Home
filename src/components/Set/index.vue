      ...
      <el-collapse-item title="Wallpaper" name="1">
        <div class="bg-set">
          <el-radio-group v-model="bgSet" text-color="#ffffff">
            <el-radio label="0" size="large" border>Default</el-radio>
            <el-radio label="1" size="large" border>Bing Daily</el-radio>
            <el-radio label="2" size="large" border>Scenery</el-radio>
            <el-radio label="3" size="large" border>Anime</el-radio>
          </el-radio-group>
        </div>
      </el-collapse-item>
      <el-collapse-item title="Orter" name="2">
        <div class="item">
          <span class="text">显示建站日期</span>
          <el-switch v-model="siteStartShow" inline-prompt :active-icon="CheckSmall" :inactive-icon="CloseSmall" />
        </div>
        <div class="item">
          <span class="text">显示音乐面板</span>
